...
// Vercel: extend serverless function timeout to 30s (EarnPaste API takes ~5s)
...
// Shared axios instance with 25s timeout (EarnPaste averages ~5s, cold starts can be slower)
const earnPasteClient = axios.create({
  timeout: 25000,
  headers: {
